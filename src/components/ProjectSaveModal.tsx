...
export const ProjectSaveModal = () => {
  ...
  const onProjectSave = async () => {
    ...
    const thumbnail = await getBase64Thumbnail({ file, scale: 0.1 }) dispatch(saveProject(projectName, thumbnail)) setProjectName("")
    dispatch(hide())
    }
